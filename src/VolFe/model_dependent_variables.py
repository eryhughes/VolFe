...
def C_S(PT, melt_wf, models=default_models):
    ...
    if model in [
        ...
        # Not benchmarked
        if model in ["Gorojovsky26_eq8", "Gorojovsky26_eq8_Thomas26_eq14"]:
            logC = (
                0.3
                + (
        ...
        elif model in ["Gorojovsky26_eq9", "Gorojovsky26_eq9_Thomas26_eq14"]:
            logC = (
                0.646657
                + (
                    (
...
def SCSS(PT, melt_wf, models=default_models):
    ...
    # aFeOsil using eq. (4) Wood & Wade (2013) https://doi.org/10.1007/s00410-013-0896-z
        ...
        RTlnyFeO = (
            -18994.0
            + 99579.0 * melt_comp["Na"]
            + 192553.0 * melt_comp["Al"] * melt_comp["Si"]
            + 282789.0 * melt_comp["Ca"] * melt_comp["Mg"]
            + 79492.0 * melt_comp["Ca"] ** 2.0
            + 120972.0 * (melt_comp["Fe2"] + melt_comp["Fe3"]) ** 2.0
        )
